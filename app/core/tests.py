...
class WallPostDeletionTests(TestCase):
    ...
    def test_deleted_wall_post_shows_placeholder_and_hides_actions(self):
    ...
    def test_ajax_delete_returns_updated_wall_item_html_without_redirect(self):
        self.client.force_login(self.moderator)
        ...
        self.assertNotIn(reverse('core:delete_wall_post', kwargs={'pk': self.wall_post.pk}), data['html'])
